...
def dashboard():
    ...
    <body style="background:var(--gray);">
        <nav class="nav"><span class="logo">DASH<span>BOARD</span></span><a href="/logout" style="color:red; text-decoration:none; font-weight:600;">Logout</a></nav>
        <div class="container">
            <div style="background:#fff; padding:25px; border-radius:25px; border:1px solid #eee; margin-bottom:30px;">
                ...
                <form action="/add" method="POST" enctype="multipart/form-data">
                    ...
                    <label style="font-size:12px; font-weight:600; display:block; margin-bottom:5px;">Select Image:</label>
